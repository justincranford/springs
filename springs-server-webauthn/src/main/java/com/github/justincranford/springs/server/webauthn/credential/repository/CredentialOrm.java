...
import com.github.justincranford.springs.server.webauthn.credential.repository.converter.ClientRegistrationExtensionOutputsConverter;
...
@SQLDelete(sql="UPDATE credential SET pre_delete_date_time=CURRENT_TIMESTAMP WHERE internal_id=? AND version=?")
...
public class CredentialOrm extends AbstractEntity {
    ...
    @JoinColumn(name="user_identity_internal_id",nullable=false)
