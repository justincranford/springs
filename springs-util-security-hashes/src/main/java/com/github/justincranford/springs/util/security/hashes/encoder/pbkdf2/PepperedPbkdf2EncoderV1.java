...
public final class PepperedPbkdf2EncoderV1 {
	public static final class RandomSalt extends PepperedHashEncoderV1 {
		public RandomSalt(@NotNull HashParametersAndHashPeppers parametersAndMacs, @Min(Constraints.MIN_RAND_BYTES_LEN) int saltBytesLen) {
	...
	public static final class DerivedSalt extends PepperedHashEncoderV1 {
		public DerivedSalt(@NotNull HashParametersAndHashPeppers parametersAndMacs, @Min(Constraints.MIN_DER_BYTES_LEN) int saltBytesLen) {
	...
	public static final class ConstantSalt extends PepperedHashEncoderV1 {
		public ConstantSalt(@NotNull HashParametersAndHashPeppers parametersAndMacs, @NotEmpty byte[] saltBytes) {
