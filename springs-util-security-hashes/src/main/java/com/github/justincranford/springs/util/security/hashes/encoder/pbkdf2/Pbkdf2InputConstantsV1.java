...
public class Pbkdf2InputConstantsV1 extends HashInputConstants {
    ...
    @Override
    @NotNull
    public Pbkdf2AlgorithmV1 algorithm() {
    ...
    @Override
    @NotEmpty
    public List<String> canonicalObjects() {
        return List.of(
    ...
    @Override
    @NotEmpty
    public HashInputConstants decode(
        ...
        return new Pbkdf2InputConstantsV1(algorithmDecoded, super.codec(), hashBytesLenDecoded, iterationsDecoded);
    }
    ...
    public Boolean recompute(
        ...
        return (expectedHashInputVariablesBytesLength != actualHashInputVariablesBytesLength)
