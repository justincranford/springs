...
//		public static final DerivedSalt NONE_NULL_NULL_NULL               = new DerivedSalt(ParametersAndPeppers.NONE_NULL_NULL_NULL, Defaults.DER_LEN_BYTES);
	...
	public static class InputVariables {
		...
		public static final HashPepperInputVariables HPWD    = new HashPepperInputVariables(new Pepper(Key.NULL, null,                  new byte[0], new byte[0], PepperOptions.HMAC_ALG, PepperOptions.ENC_DEC));
		public static final HashPepperInputVariables HPWDCTX = new HashPepperInputVariables(new Pepper(Key.NULL, null,                  new byte[3], new byte[2], PepperOptions.HMAC_ALG, PepperOptions.ENC_DEC));
		public static final HashPepperInputVariables HKEY    = new HashPepperInputVariables(new Pepper(Key.HMAC, null,                  new byte[0], new byte[0], PepperOptions.HMAC_ALG, PepperOptions.ENC_DEC));
		public static final HashPepperInputVariables HKEYCTX = new HashPepperInputVariables(new Pepper(Key.HMAC, null,                  new byte[3], new byte[2], PepperOptions.HMAC_ALG, PepperOptions.ENC_DEC));
		public static final HashPepperInputVariables CPWD    = new HashPepperInputVariables(new Pepper(Key.NULL, PepperOptions.DER_ALG, new byte[0], new byte[0], PepperOptions.CMAC_ALG, PepperOptions.ENC_DEC));
		public static final HashPepperInputVariables CPWDCTX = new HashPepperInputVariables(new Pepper(Key.NULL, PepperOptions.DER_ALG, new byte[3], new byte[2], PepperOptions.CMAC_ALG, PepperOptions.ENC_DEC));
		public static final HashPepperInputVariables CKEY    = new HashPepperInputVariables(new Pepper(Key.CMAC, PepperOptions.DER_ALG, new byte[0], new byte[0], PepperOptions.CMAC_ALG, PepperOptions.ENC_DEC));
		public static final HashPepperInputVariables CKEYCTX = new HashPepperInputVariables(new Pepper(Key.CMAC, PepperOptions.DER_ALG, new byte[3], new byte[2], PepperOptions.CMAC_ALG, PepperOptions.ENC_DEC));
	}

	public static class PreHash {
		public static final HashPepperPreHash NULL    = null;
		public static final HashPepperPreHash HPWD    = new HashPepperPreHash(new Pepper(Key.NULL,  null,                  new byte[0], new byte[0], PepperOptions.HMAC_ALG, PepperOptions.ENC_DEC));
		public static final HashPepperPreHash HPWDCTX = new HashPepperPreHash(new Pepper(Key.NULL,  null,                  new byte[3], new byte[2], PepperOptions.HMAC_ALG, PepperOptions.ENC_DEC));
		public static final HashPepperPreHash HKEY    = new HashPepperPreHash(new Pepper(Key.HMAC,  null,                  new byte[0], new byte[0], PepperOptions.HMAC_ALG, PepperOptions.ENC_DEC));
		public static final HashPepperPreHash HKEYCTX = new HashPepperPreHash(new Pepper(Key.HMAC,  null,                  new byte[3], new byte[2], PepperOptions.HMAC_ALG, PepperOptions.ENC_DEC));
		public static final HashPepperPreHash CPWD    = new HashPepperPreHash(new Pepper(Key.NULL,  PepperOptions.DER_ALG, new byte[0], new byte[0], PepperOptions.CMAC_ALG, PepperOptions.ENC_DEC));
		public static final HashPepperPreHash CPWDCTX = new HashPepperPreHash(new Pepper(Key.NULL,  PepperOptions.DER_ALG, new byte[3], new byte[2], PepperOptions.CMAC_ALG, PepperOptions.ENC_DEC));
		public static final HashPepperPreHash CKEY    = new HashPepperPreHash(new Pepper(Key.CMAC,  PepperOptions.DER_ALG, new byte[0], new byte[0], PepperOptions.CMAC_ALG, PepperOptions.ENC_DEC));
		public static final HashPepperPreHash CKEYCTX = new HashPepperPreHash(new Pepper(Key.CMAC,  PepperOptions.DER_ALG, new byte[3], new byte[2], PepperOptions.CMAC_ALG, PepperOptions.ENC_DEC));
	}

	public static class PostHash {
		public static final HashPepperPostHash NULL    = null;
		public static final HashPepperPostHash HPWD    = new HashPepperPostHash(new Pepper(Key.NULL,  null,                  new byte[0], new byte[0], PepperOptions.HMAC_ALG, PepperOptions.ENC_DEC));
		public static final HashPepperPostHash HPWDCTX = new HashPepperPostHash(new Pepper(Key.NULL,  null,                  new byte[3], new byte[2], PepperOptions.HMAC_ALG, PepperOptions.ENC_DEC));
		public static final HashPepperPostHash HKEY    = new HashPepperPostHash(new Pepper(Key.HMAC,  null,                  new byte[0], new byte[0], PepperOptions.HMAC_ALG, PepperOptions.ENC_DEC));
		public static final HashPepperPostHash HKEYCTX = new HashPepperPostHash(new Pepper(Key.HMAC,  null,                  new byte[3], new byte[2], PepperOptions.HMAC_ALG, PepperOptions.ENC_DEC));
		public static final HashPepperPostHash CPWD    = new HashPepperPostHash(new Pepper(Key.NULL,  PepperOptions.DER_ALG, new byte[0], new byte[0], PepperOptions.CMAC_ALG, PepperOptions.ENC_DEC));
		public static final HashPepperPostHash CPWDCTX = new HashPepperPostHash(new Pepper(Key.NULL,  PepperOptions.DER_ALG, new byte[3], new byte[2], PepperOptions.CMAC_ALG, PepperOptions.ENC_DEC));
		public static final HashPepperPostHash CKEY    = new HashPepperPostHash(new Pepper(Key.CMAC,  PepperOptions.DER_ALG, new byte[0], new byte[0], PepperOptions.CMAC_ALG, PepperOptions.ENC_DEC));
		public static final HashPepperPostHash CKEYCTX = new HashPepperPostHash(new Pepper(Key.CMAC,  PepperOptions.DER_ALG, new byte[3], new byte[2], PepperOptions.CMAC_ALG, PepperOptions.ENC_DEC));
	}
