...
import static com.github.justincranford.springs.util.basic.TextEncDec.HEX_LC_LENIENT;
import static com.github.justincranford.springs.util.basic.TextEncDec.HEX_LC_STRICT;
import static com.github.justincranford.springs.util.basic.TextEncDec.HEX_UC_LENIENT;
import static com.github.justincranford.springs.util.basic.TextEncDec.HEX_UC_STRICT;
...
import com.github.justincranford.springs.util.basic.TextEncDec.HexEncDec;

@SuppressWarnings({"nls", "static-method"})
public class HexEncDecTest {
	...
	private static void verifyEncodeSuccess(final HexEncDec hexEncDec, final byte[] unencodedBytes, final String encodedString) {
	...
	private void verifyDecodeSuccess(final HexEncDec hexEncDec, final String encodedString, final byte[] unencodedBytes) {
	...
	private void verifyStrictDecodeFail(final HexEncDec hexEncDec, final String encodedString) {
	...
	private void verifyUnevenFail(final HexEncDec hexEncDec) {
	...
	private void verifyNullFail(final HexEncDec hexEncDec) {
