...
public class PasswordConstraintsValues {
    ...
    public static final int MAX_SPECIALS_MIN            =  0, MAX_SPECIALS_DEFAULT            =   8, MAX_SPECIALS_MAX            = 128;
    ...
    public static final int MAX_WHITESPACE_MIN          =  0, MAX_WHITESPACE_DEFAULT          =   0, MAX_WHITESPACE_MAX          = 128; // Too many may not be ideal
}
