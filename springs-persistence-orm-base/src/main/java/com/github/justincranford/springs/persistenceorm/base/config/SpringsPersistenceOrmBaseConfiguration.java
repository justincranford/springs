...
@ComponentScan(basePackages={"com.github.justincranford.springs.persistenceorm.base"})
@EnableJpaRepositories(basePackages={"com.github.justincranford.springs.persistenceorm.base"}, repositoryFactoryBeanClass = EnversRevisionRepositoryFactoryBean.class)
